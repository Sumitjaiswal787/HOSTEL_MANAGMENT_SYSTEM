      ...
      //  $sql = "INSERT INTO Hostel_Manager (Student_id, Fname, Lname, Mob_no, Dept, Year_of_study, Pwd) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        //$stmt = mysqli_stmt_init($conn);
          ...
          if($row = mysqli_fetch_assoc($result)){
            ...
            $zz = 0;
            $sql = "INSERT INTO `hostel_manager` (Hostel_man_id,Username, Fname, Lname, Mob_no, Hostel_id, Email, Pwd, Isadmin) VALUES ( '0','$username', '$fname', '$lname', '$mobile', '$HostelID', '$email', '$hashedPwd', '$zz')";
