	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home.php">COLLEGE<span class="display"> CLUB</span></a></h1>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="index.html">COLLEGE <span class="display"> CLUB</span></a>
		</div>
		<div class="footer-grid">
			...
			<div class="agileits_w3layouts-copyright mt-4 text-center">
				<p>© 2023 Intrend. All Rights Reserved | Design by <a href="#" target="=_blank">COLLEGE CLUB</a></p>
		</div>
		</div>
	</div>
</footer>
